...
public class ProtocolV6ServerCodecs implements FrameCodec.CodecGroup {
  @Override
  public void registerCodecs(Registry registry) {
    ...
    registry
        ...
        .addEncoder(new Error.Codec(ProtocolConstants.Version.V6))
        .addEncoder(new Event.Codec(ProtocolConstants.Version.V6))
