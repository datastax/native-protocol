...
Table of Contents
  ...
  8. Result paging
  9. Error codes
  10. Changes from CQL binary protocol v5
...
10. Changes from CQL binary protocol version 5
  ...
  * Does _not_ have keyspace field in QUERY, PREPARE, and BATCH messages (Sections 4.1.4, 4.1.5, and 4.1.7 of native-protocol-v5).
  * Does _not_ have [int] flags field in PREPARE message (Section 4.1.5 of native-protocol-v5).
